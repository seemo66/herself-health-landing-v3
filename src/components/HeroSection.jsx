      ...
      >
        <div className="md:w-[45%] lg:w-[45%] xl:w-[45%] md:max-w-7xl">
          ...
          <h2 className="text-[24px] text-darkPink text-lg font-medium mb-6 xl:text-[30px] xl:leading-tight">
            ...
            miss the full picture of women’s health after 50
          </h2>
          ...
          <p className="font-untitled text-[#1D2534] text-[18px] mb-6 leading-tight md:text-[21px] md:hidden 2xl:block ">
            The Herself Health Membership is different. You get longer visits, providers trained in
            women’s health, and a care team that connects hormones, sleep, mood, bone health, heart
            health, and more into one plan that fits your life.
          </p>
          ...
          <p className="font-untitled text-[#1D2534] text-[14px] md:text-[21px] leading-tight md:hidden 2xl:block">
            <em>
